...
namespace Convergence.IO.EPICS
{
  ...
  internal readonly struct ConnectionStatusChangedEventArgs 
  {
    ...
    [ApiWrapper.OriginalName("chid")] public readonly IntPtr pChannel ;
    [ApiWrapper.OriginalName("op")]   public readonly Int32  connectionState ; // Either 'UP' or 'DOWN' ... 
  }
  ...
  public struct ValueUpdateNotificationEventArgs 
  {
    ...
    [ApiWrapper.OriginalName( "type"   )] public Int32  dbrType   ; // 'DBR_' type of the value returned ; or -1 !!!
    [ApiWrapper.OriginalName( "count"  )] public Int32  nElements ; // Element count returned ... may be zero ???
    [ApiWrapper.OriginalName( "dbr"    )] public IntPtr pDbr      ; // Pointer to DBR_ struct returned ; null if status is not ECA_NORMAL
    [ApiWrapper.OriginalName( "status" )] public Int32  ecaStatus ; // ECA_XXX status
  }
  ...
  internal struct dbr_class_name // Not yet tried ...
  {
    ...
    [MarshalAs(UnmanagedType.ByValTStr,SizeConst=ChannelAccessConstants.MAX_STRING_SIZE)]
    public String value ;
  } ;

  [StructLayout(LayoutKind.Sequential)]
  [ApiWrapper.OriginalStructType(typeof(StructsAsDefinedInC.epicsTimeStamp))]
  internal struct EpicsTimeStamp
  {
    [ApiWrapper.OriginalName( "secPastEpoch" )] public UInt32 secPastEpoch ; // Seconds since 00:00 Jan 1st,1990
    [ApiWrapper.OriginalName( "nsec"         )] public UInt32 nsec ;         // NanoSeconds within that second
  }
